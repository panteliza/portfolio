        ...
        >
          ...
          <div className="space-y-6">
            ...
            <p className="max-w-xl text-sm leading-7 text-white/70 sm:text-base">
              ...
              and user-friendly web applications using React.js, Next.js, and
              clean UI/UX design. Experienced in developing real-world projects
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                { icon: <Wand2 size={16} />, label: "Clean UI/UX" },
                { icon: <Shield size={16} />, label: "Responsive Design" },
                ...
                >
                  <span className="text-white/70">{x.icon}</span>
                  {x.label}
                </span>
              ))}
            </div>
